...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6285731798088?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6285731798088?text=JADIBOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
let btn = [{
                         ...
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        xavior.send5ButImg(m.chat, anu, 'FIRBOTZ-MD', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, 'FIRBOTZ-MD', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, 'FIRBOTZ-MD', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, 'FIRBOTZ-MD', btn)
                        } else if (setbot.templateLocation) {
                        xavior.send5ButLoc(m.chat, anu, 'FIRBOTZ-MD', global.thumb, btn)
                        }
            break
case 'gopay': {
                m.reply('NOPE GOPAY: 081934761809')
            }
            break
case 'dana': {
                m.reply('NOPE DANA: 081934761809')
            }
            break
case 'pulsa': {
...
let btn = [{
                                ...
                                urlButton: {
                                    displayText: 'Website Bot',
                                    url: 'https://github.com/firdibotz'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Rules❗',
...
let btn = [{
                        ...
                        xavior.send5ButLoc(m.chat, anu, 'FIRBOTZA-MD', global.thumb, btn)
                        }
                     }
            break
case 'downloadermenu': {
